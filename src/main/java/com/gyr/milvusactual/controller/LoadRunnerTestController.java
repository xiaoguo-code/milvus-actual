...
//import com.gyr.milvusactual.common.thread.ThreadPoolContextManager;
...
//            return "集合名不能为空！";
//        }
//        Boolean loadCollection = vectorDbService.loadCollection(collectionName);
//        log.info("加载集合至内存,response:{}", loadCollection);
//
//        return loadCollection.toString();
//    }
//
//    /**
//     *
...
//            return "集合名不能为空！";
//        }
//        Boolean aBoolean = vectorDbService.releaseCollection(collectionName);
//        log.info("加载集合至内存,response:{}", aBoolean.toString());
//
...
//
//
////        R<RpcStatus> rpcStatusR = milvusService.loadCollection(collectionName);
...
//                log.info(AlbumCollectionConfig.Field.ID + ":" + idScore.getLongID() + "         grid_id:" + gridIddData.get(j) +
...
////        vectorDbService.createCollection(createCollectionReq);
////        //创建分区
////        vectorDbService.createPartition(collectionName, partitionName);
////        //创建索引
