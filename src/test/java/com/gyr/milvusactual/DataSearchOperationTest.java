...
//
//        //指定输出字段
//        List<String> search_output_fields = Arrays.asList(AlbumCollectionConfig.Field.ID);
//
//
//        //查询参数
...
//                .withVectorFieldName(AlbumCollectionConfig.Field.FEATURE)           //向量字段名
...
//                System.out.println(AlbumCollectionConfig.Field.ID + ":" + idScore.getLongID()  + "         distance:" + idScore.getScore());
//            }
//        }
//    }
//
...
//
//        //指定输出字段
//        List<String> search_output_fields = Arrays.asList(AlbumCollectionConfig.Field.ID, AlbumCollectionConfig.Field.QUALITY_SCORE,"lon","lat");
//
//        //查询参数
//        List<List<Float>> search_vectors = Arrays.asList(Arrays.asList(0.1f, 0.2f));
//
...
//            List<SearchResultsWrapper.IDScore> scores = searchResultsWrapper.getIDScore(i);
//
//            List<?> fieldData = searchResultsWrapper.getFieldData(AlbumCollectionConfig.Field.QUALITY_SCORE, i);
//
//            for (int j = 0; j < scores.size(); j++) {
//
//                SearchResultsWrapper.IDScore idScore = scores.get(j);
//                System.out.println(AlbumCollectionConfig.Field.ID + ":" + idScore.getLongID() + "         quality_score:" + fieldData.get(j) + "         distance:" + idScore.getScore());
//            }
//        }
//    }
//
...
//
//        //指定输出字段
//        List<String> search_output_fields = Arrays.asList(AlbumCollectionConfig.Field.ID, AlbumCollectionConfig.Field.QUALITY_SCORE);
//
//        //查询参数
//        List<List<Float>> search_vectors = Arrays.asList(Arrays.asList(0.1f, 0.2f));
//
...
//        List<?> faceIdList = queryResultsWrapper.getFieldWrapper(AlbumCollectionConfig.Field.ID).getFieldData();
//        List<?> qualityScoreList = queryResultsWrapper.getFieldWrapper(AlbumCollectionConfig.Field.QUALITY_SCORE).getFieldData();
//        for (int j = 0; j < faceIdList.size(); j++) {
//
//            System.out.println(AlbumCollectionConfig.Field.ID + ":" + faceIdList.get(j) + "         quality_score:" + qualityScoreList.get(j));
//        }
//
//    }
//
